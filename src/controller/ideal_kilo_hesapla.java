...
public class ideal_kilo_hesapla {
    
    
    public static void hesapla(oturum yo, JLabel AdSoyadLabel, JLabel YasLabel, JLabel KiloLabel, JLabel HedefKiloLabel, JLabel TavsiyeLabel,  JLabel vki_label) {
