...
import controller.kullaniciEkle;
...
public class kayitOl extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(243, 408));
        setResizable(false);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        yk.setKad(kad_field.getText());
        yk.setKsifre(ksifre_field.getText());
        yk.setAd(ad_field.getText());
        yk.setSoyad(soyad_field.getText());
        yk.setYas(yas_field.getText());
        yk.setKilo(kilo_field.getText());
        yk.setBoy(boy_field.getText());

        if (kilovermek_radio.isSelected()) {
            yk.setKilotercih("kvermek");
        } else if (kilokorumak_radio.isSelected()) {
            yk.setKilotercih("kkorumak");
        } else {
            yk.setKilotercih("kalmak");
        }

        if (erkek_radio.isSelected()) {
            yk.setCinsiyet("erkek");
        } else {
            yk.setCinsiyet("kadin");
        }
