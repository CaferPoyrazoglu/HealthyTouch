...
import controller.malzeme_ekle;
 ...
 * @author LENOVO
 */
public class malzemeEkleFrame extends javax.swing.JFrame {

    /**
     * Creates new form malzemeEkleFrame
     */
    public malzemeEkleFrame() {
        initComponents();
    }
    ...
    private void malzeme_ekle_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_malzeme_ekle_buttonActionPerformed
        ...
        malzeme_ekle me = new malzeme_ekle();
        try {
            me.ekle(malzeme_ad_field,karbon_field,pro_field,yag_field,alergen_field);
            this.dispose();
            
            
            
        } catch (SQLException ex) {
            Logger.getLogger(malzemeEkleFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(malzemeEkleFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new malzemeEkleFrame().setVisible(true);
            }
        });
    }
